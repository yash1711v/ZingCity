...
class AgencyInformation extends StatelessWidget {
  const AgencyInformation(
      {super.key, required this.agencyDetails});
  ...
  Widget build(BuildContext context) {
    ...
    final agencyImage = agencyDetails.agency!.profile!.image.isNotEmpty
        ? agencyDetails.agency!.profile!.image
              ...
              child: Column(
                ...
                children: [
                  Center(
                    child: ClipOval(
                      child: CustomImage(
                        path: RemoteUrls.imageUrl(agencyImage),
                    ...
                    children: [
                      Flexible(
                        child: CustomTextStyle(
                          text: agencyDetails.agency!.profile!.companyName,
                          fontSize: 20.0,
                          fontWeight: FontWeight.w600,
                          color: whiteColor,
                        ),
                      ),
                      Utils.horizontalSpace(agencyDetails.agency!.kycStatus == 1 ? 4.0 : 0),
                      if (agencyDetails.agency!.kycStatus == 1) ...[
                        const Icon(
                  ...
                  // ),
                  CustomTextStyle(
                    text: agencyDetails.agency!.profile!.tagLine,
                    fontSize: 14.0,
