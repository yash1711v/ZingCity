              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Text(
                        '${(state.buyProperties ?? []).length ?? 0} results found',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 14,
                          fontFamily: 'DM Sans',
                      ...
                      children: [
                        SingleChildScrollView(
                          child: Column(
                            children: [
                              ListView.builder(
                                  itemCount: (state.buyProperties ?? []).length,
                                  shrinkWrap: true,
                                  physics:
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              CustomNetworkImageWidget(
                                                ...
                                                height: 94.83,
                                                image:
                                                "${RemoteUrls.rootUrl}${(state.buyProperties ?? [])[index].thumbnailImage}",
                                              ),
                                              // Container(
                                              //   width: 94.83,
                                              //   height: 94.83,
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                      ...
                                                      child: Text(
                                                        (state.buyProperties ?? [])[index].title ?? "",
                                                        maxLines: 1,
                                                        style: TextStyle(
                                                            color: Colors.black,
                                                            fontSize: 16,
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        SizedBox(
                                                          ...
                                                          child: Text(
                                                            removeHtmlTags((state.buyProperties ?? [])[index].description ?? ""),
                                                            maxLines: 3,
                                                            style: TextStyle(
                                                              color: Colors
                                                                  .black,
