                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                           Text(
                            '${(state.rentProperties ?? []).length ?? 0} results found',
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 14,
                              fontFamily: 'DM Sans',
                          ...
                          children: [
                            SingleChildScrollView(
                              child: Column(
                                children: [
                                  ListView.builder(
                                      itemCount: (state.rentProperties ?? []).length,
                                      shrinkWrap: true,
                                      physics:
                                              ...
                                              child: Row(
                                                children: [
                                                 ...
                                                 width: 94.83,
                                                   height: 94.83,
                                                    image:
                                                    "${RemoteUrls.rootUrl}${(state.rentProperties ?? [])[index].thumbnailImage}",
                                                  ),
                                                  // Container(
                                                  //   width: 94.83,
                                                  //   height: 94.83,
                                                      ...
                                                      children: [
                                                        ...
                                                        // ),
                                                         SizedBox(
                                                           ...
                                                           child: Text(
                                                            (state.rentProperties ?? [])[index].title ?? "",
                                                            maxLines: 1,
                                                            style: TextStyle(
                                                              color: Colors.black,
                                                              fontSize: 16,
                                                         ...
                                                         Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            SizedBox(
                                                              ...
                                                              child: Text(
                                                                removeHtmlTags((state.rentProperties ?? [])[index].description ?? ""),
                                                                maxLines: 3,
                                                                style: TextStyle(
                                                                  color: Colors
                                                                      .black,
